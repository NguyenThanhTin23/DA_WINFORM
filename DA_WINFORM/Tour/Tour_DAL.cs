    ...
    WHERE matour = (
        ...
        public int GetTongSoTour()
        {
            ...
            try
            {
                cmd = new SqlCommand(sql, con);
                con.Open();
                totalTours = (int)cmd.ExecuteScalar();
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        public int GetSoTourTrongNuoc()
        {
            string sql = "SELECT COUNT(*) FROM TOUR WHERE MALTOUR = 'LT01'";
            SqlConnection con = dataCon.getConnect();
            int total = 0;
        ...
        public int GetSoTourNgoaiNuoc()
        {
            string sql = "SELECT COUNT(*) FROM TOUR WHERE MALTOUR = 'LT02'";
            SqlConnection con = dataCon.getConnect();
            int total = 0;
