...
namespace DA_WINFORM
{
    public partial class frmDatTour : Form
    {
        ...
        public frmDatTour(string username)
        {
            InitializeComponent();
        ...
        {/*
            ...
            frmThongTinTour TTTourfrm = new frmThongTinTour(username);
            ...
            // Điều kiện để bật/tắt nút Đặt Tour
            if (calDays.TotalDays <= 1 || soLuongConLai == 0)
            {
                TTTourfrm.btlDatTour.Enabled = false;
            }
            else
